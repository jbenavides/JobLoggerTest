namespace JobLoggerApp.Demo
{
    ...
    public interface IConsoleLoggerCommand : ICommand {}

    public class ConsoleLoggerCommand : IConsoleLoggerCommand
    {
        private readonly IConsoleLogger _consoleLogger;

        public ConsoleLoggerCommand(IConsoleLogger consoleLogger)
        {
            _consoleLogger = consoleLogger;
        }

        public string Description => "Log message in console.";
        public void Execute()
        {
            ...
            try
            {
                _consoleLogger.LogMessage((MessageType) messageType, message);
            }
